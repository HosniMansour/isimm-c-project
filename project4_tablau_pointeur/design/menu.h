...
#include "../travail/fusion.h"
    ...
    int k=1;
    int choix,c;
    int *t1,*t2,*t3,*t4,*t5,*t6,*t7,*t8,*t9,*t10,*t11,*t12,*br,*r,*t15,*a,*t16;
    int t13[50],t14[50];
...
void menuremplir()
{
	do{
        do{
			...
			gotoxy(40,10);printf("1/ Remplissage T1 ");
			gotoxy(40,11);printf("2/ Remplissage T2 ");
			gotoxy(40,12);printf("3/ Remplissage T3 ");
			gotoxy(40,13);printf("4/ Remplissage T4 ");
			gotoxy(40,14);printf("5/ Remplissage T5 ");
			gotoxy(40,15);printf("6/ Remplissage T6 ");
			gotoxy(40,16);printf("7/ Remplissage T7 ");
		...
		switch(c)
		{
			case 1:cadremenu("Remplissage T1",3);saisie_taille(&n1);t1=(int*)malloc(n1*sizeof(int));chargement1(t1,n1);
                ...
                getch();break;
			case 2:cadremenu("Remplissage T2",3);saisie_taille(&n2);t2=(int*)malloc(n2*sizeof(int));chargement1(t2,n2);
                ...
                getch();break;
			case 3:cadremenu("Remplissage T3",3);saisie_taille(&n3);t3=(int*)malloc(n3*sizeof(int));chargement2(t3,n3);
                ...
                getch();break;
			case 4:cadremenu("Remplissage T4",3);saisie_taille(&n4);t4=(int*)malloc(n4*sizeof(int));chargement2(t4,n4);
                ...
                getch();break;
			case 5:cadremenu("Remplissage T5",3);if(nc1==0){saisie_taille(&nc1);}t5=(int*)malloc(nc1*sizeof(int));t6=(int*)malloc(nc1*sizeof(int));chargement3(t5,nc1);
                ...
                getch();break;
			case 6:cadremenu("Remplissage T6",3);if(nc1==0){saisie_taille(&nc1);}t5=(int*)malloc(nc1*sizeof(int));t6=(int*)malloc(nc1*sizeof(int));chargement3(t6,nc1);
                gotoxy(10,10+nc1);printf("Vous avez saisire T : ");for(int i=0;i<nc1;i++){printf("%d ",t6[i]);}
                gotoxy(10,12+nc1);printf("-----------------------------------------------");
                gotoxy(10,14+nc1);printf("Appuyer sur une touche pour retourner au menu ");
                getch();break;
			case 7:cadremenu("Remplissage T7",3);saisie_taille(&n7);t7=(int*)malloc(n7*sizeof(int));chargement3(t7,n7);
                ...
                getch();break;
			case 8:cadremenu("Remplissage T8",3);saisie_taille(&n8);t8=(int*)malloc(n8*sizeof(int));chargement5(t8,n8);
                gotoxy(10,10);printf(" T : ");for(int i=0;i<n8;i++){printf("%d ",t8[i]);}
                gotoxy(10,12);printf("-----------------------------------------------");
                gotoxy(10,14);printf("Appuyer sur une touche pour retourner au menu ");
                getch();break;
			case 9:cadremenu("Remplissage T9",3);saisie_taille(&n9);t9=(int*)malloc(n9*sizeof(int));chargement2(t9,n9);
                ...
                getch();break;
			case 10:cadremenu("Remplissage T10",3);if(nc2==0){saisie_taille(&nc2);}t10=(int*)malloc(nc2*sizeof(int));chargement4(t10,nc2);
                gotoxy(10,10);printf(" T : ");for(int i=0;i<nc2;i++){printf("%d ",t10[i]);}
                gotoxy(10,12);printf("-----------------------------------------------");
                gotoxy(10,14);printf("Appuyer sur une touche pour retourner au menu ");
                getch();break;
			case 11:cadremenu("Remplissage T11",3);if(nc2==0){saisie_taille(&nc2);}t11=(int*)malloc(nc2*sizeof(int));chargement4(t11,nc2);
                gotoxy(10,10);printf(" T : ");for(int i=0;i<nc2;i++){printf("%d ",t11[i]);}
                gotoxy(10,12);printf("-----------------------------------------------");
                gotoxy(10,14);printf("Appuyer sur une touche pour retourner au menu ");
                getch();break;
			case 12:cadremenu("Remplissage T12",3);saisie_taille(&n12);t12=(int*)malloc(n12*sizeof(int));chargement2(t12,n12);
                    ...
                    if(n1==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n1);t1=(int*)malloc(n1*sizeof(int));
                            chargement1(t1,n1);
                        }
                            clrscr();cadremenu("Recherche Distincts",3);
                            gotoxy(10,10);printf("T1 = ");gotoxy(15,10);afficher(t1,n1);
                    ...
                    if(n3==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n3);t3=(int*)malloc(n3*sizeof(int));
                            chargement1(t3,n3);
                        }
                            clrscr();cadremenu("Tri Par Selection",3);
                            gotoxy(10,10);printf("T3 = ");gotoxy(15,10);afficher(t3,n3);
                            tri_selection(t3,n3);
                            gotoxy(10,12);printf("Apres Tri : ");
                            gotoxy(10,14);printf("T3 = ");gotoxy(15,14);afficher(t3,n3);
                            gotoxy(10,20);printf("-----------------------------------------------");
                            gotoxy(10,22);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
                    ...
                    if(n4==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n4);t4=(int*)malloc(n4*sizeof(int));
                            chargement1(t4,n4);
                        }
                            clrscr();cadremenu("Tri Remplacer",3);
                            gotoxy(10,10);printf("T3 = ");gotoxy(15,10);afficher(t4,n4);
                            br=(int*)malloc(n4*sizeof(int));tri_remplacer(t4,br,n4);
                            gotoxy(10,12);printf("Apres Tri : ");
                            gotoxy(10,14);printf("B = ");gotoxy(15,14);afficher(br,n4);
                            gotoxy(10,20);printf("-----------------------------------------------");
                            gotoxy(10,22);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
                    ...
                    if(nc1==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&nc1);t5=(int*)malloc(nc1*sizeof(int));
                            chargement1(t5,nc1);
                        }
                            clrscr();cadremenu("Tri Poasition",3);
                            gotoxy(10,10);printf("T5 = ");gotoxy(15,10);afficher(t5,nc1);
                            r=(int*)malloc(nc1*sizeof(int));tri_position(t5,nc1,r);
                            gotoxy(10,12);printf("Apres Tri : ");
                            gotoxy(10,14);printf("R = ");gotoxy(15,14);afficher(r,nc1);
                            gotoxy(10,20);printf("-----------------------------------------------");
                            gotoxy(10,22);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
			case 6:menu();break;
                    ...
                    if((n3==0)||(n12==0))
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n12);t12=(int*)malloc(n12*sizeof(int));
                            chargement1(t12,n12);
                        }
                            clrscr();cadremenu("Fusion 1",3);
                            gotoxy(10,10);printf("T3 = ");gotoxy(15,10);afficher(t3,n3);
                            gotoxy(10,12);printf("T12 = ");gotoxy(15,12);afficher(t12,n12);
                            t15=(int*)malloc((n3+n12)*sizeof(int));fusion1(t3,t12,t15,n3,n12);
                            gotoxy(10,16);printf("Resultat: ");gotoxy(20,16);afficher(t15,n3+n12);
                            gotoxy(10,20);printf("-----------------------------------------------");
                            gotoxy(10,22);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
                   ...
                   if(n==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n);t10=(int*)malloc(n*sizeof(int));
                            chargement1(t10,n);
                            clrscr();cadremenu("Fusion 2 T11",3);
                            gotoxy(10,14);t11=(int*)malloc(n*sizeof(int));
                            chargement1(t11,n);
                        }
                            clrscr();cadremenu("Fusion 2",3);
                            gotoxy(10,10);printf("T10 = ");gotoxy(15,10);afficher(t10,n);
                            gotoxy(10,12);printf("T11 = ");gotoxy(15,12);afficher(t11,n);
                            t16=(int*)malloc(n*sizeof(int));fusion2(t10,t11,t16,n);
                    ...
                    if(n1==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n1);t1=(int*)malloc(n1*sizeof(int));a=(int*)malloc(n1*sizeof(int));
                            chargement1(t1,n1);
                        }
                            clrscr();cadremenu("Transfere",3);
                            gotoxy(10,10);printf("T1 = ");gotoxy(15,10);afficher(t1,n1);
                            transfere(t1,a,n1);gotoxy(10,12);printf("A =");gotoxy(15,12);afficher(a,n1);
                            gotoxy(10,14);printf("-----------------------------------------------");
                            gotoxy(10,16);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
                    ...
                    if(n2==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n2);t2=(int*)malloc(n2*sizeof(int));
                            chargement1(t2,n2);
                        }
                            clrscr();cadremenu("Insertion",3);
                            gotoxy(10,10);printf("T2 = ");gotoxy(15,10);afficher(t2,n2);
                            insertion(t2,n2);
                            gotoxy(10,16);printf("Apres insertion :");gotoxy(28,16);afficher(t2,n2+1);
                            gotoxy(10,18);printf("-----------------------------------------------");
                    ...
                    if(n9==0)
                        {
                            ...
                            gotoxy(10,14);saisie_taille(&n9);t9=(int*)malloc(n9*sizeof(int));
                            chargement1(t9,n9);
                        }
                            clrscr();cadremenu("Invertion",3);
                            gotoxy(10,10);printf("T9 = ");gotoxy(15,10);afficher(t9,n9);
                            inverse(t9,n9);
                            gotoxy(10,12);printf("Resultat : ");afficher(t9,n9);
                            gotoxy(10,14);printf("-----------------------------------------------");
                            gotoxy(10,16);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
                    ...
                    if(n9==0)
                        {
                            ...
                            clrscr();cadremenu("Rotation",3);
                            gotoxy(10,10);printf("T1 = ");gotoxy(15,10);afficher(t9,n9);
                            rotation(t9,n9);
                            gotoxy(10,12);printf("Resultat : ");afficher(t9,n9);
                            gotoxy(10,14);printf("-----------------------------------------------");
                            gotoxy(10,16);printf("Appuyer sur une touche pour retourner au menu");
                    ...
                    if((n1==0)||(n3==0))
                        {
                            ...
                            clrscr();cadremenu("Present",3);
                            gotoxy(10,10);printf("T1 = ");gotoxy(15,10);afficher(t1,n1);
                            gotoxy(10,12);printf("T3 = ");gotoxy(15,12);afficher(t3,n3);
                            n13=presents(t1,t3,t13,n1,n3);
                            gotoxy(10,14);printf("Resultat :");gotoxy(21,14);afficher(t13,n13);
                            gotoxy(10,16);printf("-----------------------------------------------");
                    ...
                    if((n1==0)||(n3==0))
                        {
                            ...
                            gotoxy(10,14);printf("Resultat :");gotoxy(21,14);afficher(t14,n14);
                            gotoxy(10,16);printf("-----------------------------------------------");
                            gotoxy(10,18);printf("Appuyer sur une touche pour retourner au menu");
                            getch();break;
